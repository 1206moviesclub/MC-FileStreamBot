...
if MY_PASS:
            ...
            [
                ...
                ["Bot Channel ❤️","ping📡","status📊","maintainers😎"]
...
async def start(b, m):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Jᴏɪɴ ɴᴏᴡ 🔓", url=f"https://telegram.me/{Var.UPDATES_CHANNEL}")
                        ]
                    ]
                ),
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/mxCLubHouse'>CLICK HERE FOR SUPPORT </a></b>",
                
                disable_web_page_preview=True)
            return
    await StreamBot.send_photo(
        chat_id=m.chat.id,
        photo ="https://graph.org/file/94a102d4f8e33639800cb.jpg",
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ [Support](https://t.me/mxCLubHouse).",
                disable_web_page_preview=True)
            return
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("✘ Main Channel ✘", url="https://telegram.dog/MoviGenX")],
